...
> Retrieve events for a sport by its slug (e.g., 'football', 'basketball'). Fetches all leagues for the sport, collects their active series, and returns combined events.



## OpenAPI

````yaml /api-reference/oapi-schemas/sports-schema.json get /v2/sports/{slug}/events
openapi: 3.0.3
info:
...
paths:
  /v2/sports/{slug}/events:
    get:
      tags:
        - Sports
      summary: Get Events By Sport Slug
      description: >-
        Retrieve events for a sport by its slug (e.g., 'football',
        'basketball'). Fetches all leagues for the sport, collects their active
        series, and returns combined events.
      operationId: SportsV2Service_GetSportEvents
      parameters:
        - name: slug
        ...
        - name: excludeEventId
          ...
          schema:
            ...
            items:
              ...
              format: int32
        - name: type
          description: 'Type: sport (default) or futures'
          in: query
          required: false
          schema:
            type: string
        - name: section
          description: 'Section: general (default) or trending'
          in: query
          required: false
          schema:
            type: string
      responses:
        '200':
          description: Sport events with sport info
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/gateway.sports.v2.GetSportEventsResponse'
        '500':
...
components:
  schemas:
    gateway.sports.v2.GetSportEventsResponse:
      type: object
      properties:
        type:
          type: string
          description: 'Type: sport or futures'
        typeTitle:
          type: string
          description: 'Subtab title: Games or Futures'
        section:
          type: string
          description: 'Section: general or trending'
        sectionTitle:
          type: string
          description: 'Section title: Sport or Trending'
        events:
          type: array
          items:
        ...
        sport:
          $ref: '#/components/schemas/gateway.sports.v2.Sport'
      description: Response containing events for a sport
    ...
    gateway.sports.v2.Sport:
      ...
      properties:
        ...
        defaultJerseyImage:
          ...
          nullable: true
      description: Consumer-facing sport representation
