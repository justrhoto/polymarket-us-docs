...
````yaml /api-reference/oapi-schemas/sports-legacy-schema.json get /v1/sports/{seriesId}/events
openapi: 3.0.3
info:
...
tags:
  - name: SportsService
paths:
  /v1/sports/{seriesId}/events:
    get:
      tags:
        - Sports
      summary: Get Sports Events
      description: >-
        Retrieve events sections for a sport series (optional trending, optional
        live, and sport section). Same structure as home page.
      operationId: SportsService_GetSportsEvents
      parameters:
        - name: seriesId
          description: Series ID (path)
          in: path
          required: true
          schema:
            type: integer
      ...
      responses:
        '200':
          description: Sections with events
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/gateway.sports.v1.GetSportsEventsSection'
        '500':
...
components:
  schemas:
    gateway.sports.v1.GetSportsEventsSection:
      type: object
      properties:
        type:
          type: string
      ...
      description: >-
        Section for GetSportsEvents: type, type_title, section, section_title,
        events, category
