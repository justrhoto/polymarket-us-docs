      ...
      parameters:
        ...
        - name: sportsMarketTypes
          ...
          schema:
            ...
            items:
              type: string
        - name: includeComboMarketCounts
          description: Include derived event-level combo market counts
          in: query
          required: false
          schema:
            type: boolean
        - name: teamId
          description: Filter to events the team participates in
          in: query
          required: false
          schema:
            type: integer
        ...
        - name: tagSlugsAll
          description: >-
            Events must carry every one of these tag slugs (AND). Contrast
            tag_slug (single) and tag_ids (OR)
          in: query
          required: false
          explode: true
          schema:
