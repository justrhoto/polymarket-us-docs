...
````yaml /institutional/oapi-schemas/report-schema.json post /v1/report/orders/search
openapi: 3.0.3
info:
  title: Report API
  version: v1.0.0
...
tags:
  - name: ReportAPI
paths:
  /v1/report/orders/search:
    post:
      tags:
        - Report
      summary: Search orders
      description: Searches for exchange orders using the given details to filter
      operationId: ReportAPI_SearchOrders
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/v1SearchOrdersRequest'
        required: true
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/v1SearchOrdersResponse'
components:
  schemas:
    v1SearchOrdersRequest:
      type: object
      properties:
        pageSize:
          type: integer
        ...
        orderStateFilter:
          $ref: '#/components/schemas/v1OrderStateFilter'
        crossId:
          type: string
        hostCrossId:
          type: string
    ...
    v1OrderStateFilter:
      ...
      description: >-
        OrderStateFilter describes a filter for searching orders that are open
        or closed.
    v1Date:
      type: object
      properties:
